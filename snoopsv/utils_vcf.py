...
def add_header_lines_tr(header_in, prefix='', extra_fields_list=None):
	...
	'##FORMAT=<ID=N_H1,Number=.,Type=String,Description="number of supporting reads in H1, from snoopSV">',
	'##FORMAT=<ID=N_H2,Number=.,Type=String,Description="number of supporting reads in H2, from snoopSV">',
	'##FORMAT=<ID=N_H0,Number=.,Type=String,Description="number of supporting reads in H0, from snoopSV">',
